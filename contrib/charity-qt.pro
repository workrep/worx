...
RESOURCES += src/qt/charity.qrc src/qt/charity_locale.qrc

TRANSLATIONS += src/qt/locale/charity_bg.ts \
                src/qt/locale/charity_de.ts \
                src/qt/locale/charity_en.ts \
                src/qt/locale/charity_es.ts \
                src/qt/locale/charity_fi.ts \
                src/qt/locale/charity_fr.ts \
                src/qt/locale/charity_it.ts \
                src/qt/locale/charity_ja.ts \
                src/qt/locale/charity_pl.ts \
                src/qt/locale/charity_pt.ts \
                src/qt/locale/charity_ru.ts \
                src/qt/locale/charity_sk.ts \
                src/qt/locale/charity_sv.ts \
                src/qt/locale/charity_vi.ts \
                src/qt/locale/charity_zh_CN.ts \
                src/qt/locale/charity_zh_TW.ts
