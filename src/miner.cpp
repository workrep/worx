...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("CHARITYMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("CHARITYMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        if (fProofOfStake) {
            ...
            if (!pblock->SignBlock(*pwallet)) {
                LogPrintf("CHARITYMiner(): Signing new block failed \n");
                continue;
            }
        ...
        LogPrintf("Running CHARITYMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadBitcoinMiner(void* parg)
{
    ...
    try {
        ...
        LogPrintf("ThreadCHARITYMiner() exception");
    } catch (...) {
        LogPrintf("ThreadCHARITYMiner() exception");
    }

    LogPrintf("ThreadCHARITYMiner exiting\n");
}
