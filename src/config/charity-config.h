/* src/config/charity-config.h.  Generated from charity-config.h.in by configure.  */
/* src/config/charity-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CHARITY_CONFIG_H

#define CHARITY_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://charity.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Charity Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Charity Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "charity"
