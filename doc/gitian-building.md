...
*Setup instructions for a gitian build of Charity using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Charity
...
- [Building Charity](#building-digiwage)
...
To build Charity (for Linux, OSX and Windows) just follow the steps under 'perform
