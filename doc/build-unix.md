UNIX BUILD NOTES
====================
Some notes on how to build Charity in Unix.
...
memory available when compiling Charity Core. With 512MB of memory or less
...
If you want to build Charity-Qt, make sure that the required packages for Qt development
...
# Configure Charity Core to use our own-built instance of BDB
cd $Charity_ROOT
