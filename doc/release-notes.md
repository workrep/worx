Charity Core version 2.3.1 is now available from:
...
Charity Core is extensively tested on multiple operating systems using
...
Charity Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Charity address of payment
